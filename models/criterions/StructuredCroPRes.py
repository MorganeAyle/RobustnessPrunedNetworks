...
from models.criterions.StructuredCroPBaseRes import StructuredCroPBaseRes
from utils.constants import SNIP_BATCH_ITERATIONS
from collections import OrderedDict


class StructuredCroPRes(StructuredCroPBaseRes):

    def __init__(self, *args, **kwargs):
        super(StructuredCroPRes, self).__init__(*args, **kwargs)
