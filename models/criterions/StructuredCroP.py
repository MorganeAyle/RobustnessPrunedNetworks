...
from models.criterions.StructuredCroPBase import StructuredCroPBase
from utils.constants import SNIP_BATCH_ITERATIONS
from collections import OrderedDict


class StructuredCroP(StructuredCroPBase):

    def __init__(self, *args, **kwargs):
        super(StructuredCroP, self).__init__(*args, **kwargs)
