from models.criterions.StructuredCroPRes import StructuredCroPRes


class StructuredCroPitRes(StructuredCroPRes):
    ...
    def __init__(self, *args, limit=0.0, lower_limit=0.5, steps=5, **kwargs):
        self.limit = limit
        super(StructuredCroPitRes, self).__init__(*args, **kwargs)
