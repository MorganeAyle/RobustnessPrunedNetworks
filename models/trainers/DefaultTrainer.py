...
class DefaultTrainer:
    ...
    def train(self):
        ...
        try:
            ...
            if self._arguments['prune_criterion'] in EARLY_CROP:
            ...
            if self._arguments['prune_criterion'] in BEFORE_TRAINING:
                self._criterion.prune(percentage=self._arguments['pruning_limit'],
                ...
                if self._arguments['prune_criterion'] in STRUCTURED:
            ...
            if self._arguments["prune_criterion"] in HYDRA:
                ...
                """
                No need to do training, return directly.
                """
                return
            ...
            for epoch in range(epoch, self._arguments['epochs'] + epoch):
                ...
                # do all related to pruning during training
            ...
            if self._is_not_finished_pruning():
                ...
                if self._arguments['prune_criterion'] == 'HYDRA':
                    ...
                    self._criterion.prune(
                        percentage=self._arguments['pruning_limit'],  # overwritten in most criterions
                        train_loader=self._train_loader,
                        manager=DATA_MANAGER,
                        local=self._arguments['local_pruning'],
                    )
